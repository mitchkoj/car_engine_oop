...
class Engine:
    ...
    @classmethod
    def produce_a_standard_benzine_engine(cls) -> "Gasoline":
        class Benzine(Gasoline):
            pass

        benzine95 = Benzine(octane=95)

        return cls(gasoline=benzine95)

    @classmethod
    def produce_a_standard_diesel_engine(cls) -> "Gasoline":
        class Diesel(Gasoline):
            pass

        benzine95 = Diesel(octane=95)

        return cls(gasoline=benzine95)

    def supply(self, gas_portion: GasPortion, seconds: float):
